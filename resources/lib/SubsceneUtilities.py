...
subscene_languages = {
    ...
    'Bengali': {'id': 52, '3let': 'ben', '2let': 'be', 'name': 'Bengali'},
    ...
    'Burmese': {'id': 53, '3let': 'mya', '2let': 'my', 'name': 'Burmese'},
    ...
    'Dutch/ English': {'id': 51, '3let': 'dut', '2let': 'nl', 'name': 'Dutch/ English'},
    'English': {'id': 13, '3let': 'eng', '2let': 'en', 'name': 'English'},
    'English/ German': {'id': 57, '3let': 'eng', '2let': 'en', 'name': 'English/ German'},
    ...
    'Kurdish': {'id': 58, '3let': 'kur', '2let': 'ku', 'name': 'Kurdish'},
    'Lithuanian': {'id': 43, '3let': 'lit', '2let': 'lt', 'name': 'Lithuanian'},
    'Malay': {'id': 50, '3let': 'may', '2let': 'ms', 'name': 'Malay'},
    'Malayalam': {'id': 55, '3let': 'mal', '2let': 'ml', 'name': 'Malayalam'},
    'Macedonian': {'id': 54, '3let': 'mac', '2let': 'mk', 'name': 'Macedonian'},
    ...
    'Sinhala': {'id': 56, '3let': 'sin', '2let': 'si', 'name': 'Sinhala'},
